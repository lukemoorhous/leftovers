...
public class Service {
	...
	public static String getWord(Map<Question, Integer> questions, Word word) {
		Entry<String, Integer> bestWord = null;
		for (Entry<String, Integer> entry : process(questions, word).entrySet()) {
			if (bestWord == null) {
				bestWord = entry;
			}
			else if (entry.getValue() > bestWord.getValue()) {
				bestWord = entry;
			}
		}
		return bestWord.getKey();
	}
